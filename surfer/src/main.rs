...
mod main_impl {
    ...
    pub(crate) fn main() -> Result<()> {
        ...
        let window_title = waves
            .as_ref()
            .map_or_else(|| "wavAnaly".to_string(), WaveSource::window_title);
        ...
        let options = eframe::NativeOptions {
            viewport: egui::ViewportBuilder::default()
                .with_app_id("io.wavanaly.wavanaly")
        ...
        eframe::run_native("wavAnaly", options, Box::new(|cc| Ok(run_egui(cc, state)?))).unwrap();
